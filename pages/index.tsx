    ...
    <div className="min-h-screen flex flex-col items-center">
      ...
      <nav className="navbar container">
        <div className="navbar-logo">
          <Image src="/images/logo.svg" alt="PlotLab Logo" width={50} height={50} />
          <span>PlotLab</span>
        </div>
        <div className="space-x-4">
          {/* Открываем модальное окно вместо перехода на login */}
          <button className="btn btn-secondary" onClick={() => setIsLoginOpen(true)}>Вход</button>
      ...
      <main className="container flex flex-col items-center text-center py-20 space-y-16">
        <section>
          ...
          <p className="text-lg text-text-light max-w-2xl mt-4">
            Пишите книги, создавайте сценарии и разрабатывайте идеи вместе с творческим сообществом. 
            Ваши проекты могут стать следующим бестселлером!
          </p>
        </section>
        ...
        <section className="cta-section">
          ...
          <p className="opacity-80 mt-4">Присоединяйтесь к сообществу авторов по всему миру</p>
